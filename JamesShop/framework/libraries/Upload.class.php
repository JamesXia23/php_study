...
//					echo '文件夹创建失败';
	 ...
	 * 多文件上传方法
	 * @access publi
	 * @param $files array 包含上传文件信息的数组，是一个二维数组
	 * @param $descs array 包含上传文件描述信息的数组，是一个二维数组
	 * @return $url_desc array 返回上传的文件路径和描述构成的数组
	 */
	public function multiUp($files,$descs){
